...
const AuthForm = () => {
    ...
    const submitHandler = (event) => {
        ...
        if (isLogin) {
            URL =
                "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC75P1CU_dMXKX13MPww9e6DxBin4Z-M4I";
        } else if (isFormValid) {
            URL =
                "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC75P1CU_dMXKX13MPww9e6DxBin4Z-M4I";
        }
        fetch(URL, {
            method: "POST",
            body: JSON.stringify({
