...
const ProfileForm = () => {
    ...
    useEffect(() => {
        fetch(
            "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyC75P1CU_dMXKX13MPww9e6DxBin4Z-M4I",
            {
                method: "POST",
                headers: {
    ...
    const updateProfile = (event) => {
        ...
        fetch(
            "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyC75P1CU_dMXKX13MPww9e6DxBin4Z-M4I",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
